      ...
      return Scaffold(
                            ...
                            child: FlatButton(
                              ...
                              onPressed: () {
                                Item item = Item(
                                  ...
                                  categoryID: categoryList[widget.listIndex].id, //catID
                                ...
                                Budget category1 = Budget(
                                  ...
                                  amount: categoryList[widget.listIndex].amount,
                                  expense: categoryList[widget.listIndex].expense +
                                ...
                                } else if (categoryList[widget.listIndex].expense >
                                    categoryList[widget.listIndex].amount * .9) {
                                  showDialog(
                                    context: context,
                                    builder: (BuildContext context) {
                                      return AlertDialog(
        ...
        body: Center(
          child: SingleChildScrollView(
            child: Column(
              children: [
                _percentage(categoryList[widget.listIndex].amount, categoryList[widget.listIndex].expense),
                Cards(
